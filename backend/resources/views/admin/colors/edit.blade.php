  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-6">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Edit color</h1>
      </div>
          ...
          <div class="w-96 mx-auto">
            <div class="pb-4">
              <div class="relative">
                ...
                <input type="name" id="name" name="name" placeholder="color name" value="{{ $color->name }}"
