  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-6">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Add new Product</h1>
      </div>
          ...
          <div class="w-96 mx-auto">
            ...
            <div class="pb-4">
              <div class="relative">
                ...
                <input type="number" id="qty" name="qty" placeholder="Quantity" value="{{ old('qty') ?? '' }}"
                  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
              </div>
              @error('qty')
                <span class="text-red-500">{{ $message }}</span>
            ...
            <div class="p-2 w-full">
              <div class="relative">
                ...
                <textarea id="desc" name="desc" placeholder="Description"
                  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ old('desc') ?? '' }}</textarea>
                @error('desc')
                  <span class="text-red-500">{{ $message }}</span>
                @enderror
              </div>
